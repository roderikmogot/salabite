...
export default function Navbar() {
  ...
  return (
    <nav className="w-full sticky shadow-md shadow-red-400 top-0 left-0 bg-body z-[9999]">
      <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        <div>
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <div className="text-red-400 w-10 h-10">
        ...
        <div>
          <div
            className={`relative flex-1 justify-self-center p-8 md:block md:p-0 md:mt-0 ${
              navbar ? "block" : "hidden"
            }`}
          >
